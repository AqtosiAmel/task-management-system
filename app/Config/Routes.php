...
$routes->get('admin/view-task/(:num)', 'TaskController::adminViewTask/$1');
$routes->get('admin/edit-task/(:num)', 'TaskController::adminEditTask/$1');
$routes->post('admin/update_task/(:num)', 'TaskController::adminUpdateTask/$1');
$routes->get('admin/delete-task/(:num)', 'TaskController::adminDelete/$1');
